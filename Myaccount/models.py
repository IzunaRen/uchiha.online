...
class User(AbstractUser):
	...
	# 扩展用户性别字段
	gender = models.BooleanField(default=False, verbose_name='性别',null=True)
	# 扩展用户头像字段,upload_to后必须是相对路径,上传路径已设置为media，因此upto不需要media/avatar，数据库avatar/...,前端用avatar.url为media/avatar/...
	avatar = ProcessedImageField(upload_to='avatar',default='',verbose_name='头像',
	...
	def get_absolute_url(self):
		return reverse('blog:user', kwargs={'pk': self.pk})
	#扩展用户生日
